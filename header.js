document.addEventListener("DOMContentLoaded", function() {
    ...
    const isHome = path === "/" || path === "/index" || path.endsWith("/index") || path === "";
    ...
    <nav class="border-b border-gray-200 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="/index" class="${linkClass(isHome)}">Home</a>
                    <a href="/faq" class="${linkClass(isFAQ)}">FAQ</a>
                    <a href="/service-areas" class="${linkClass(isAreas)}">Service Areas</a>
                    <a href="/service-policy" class="${linkClass(isPolicy)}">Service Policy</a>
                    ...
                    <a href="/index#book-now" class="bg-black text-white px-6 py-2 rounded-md font-semibold border-2 border-white hover:bg-white hover:text-black hover:border-black transition-all">Book Now</a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 shadow-lg absolute w-full left-0">
            <a href="/index" class="block py-4 px-4 border-b border-gray-100 ${isHome ? 'bg-gray-50 font-bold text-black' : 'text-gray-600'}">Home</a>
            <a href="/faq" class="block py-4 px-4 border-b border-gray-100 ${isFAQ ? 'bg-gray-50 font-bold text-black' : 'text-gray-600'}">FAQ</a>
            <a href="/service-areas" class="block py-4 px-4 border-b border-gray-100 ${isAreas ? 'bg-gray-50 font-bold text-black' : 'text-gray-600'}">Service Areas</a>
            <a href="/service-policy" class="block py-4 px-4 border-b border-gray-100 ${isPolicy ? 'bg-gray-50 font-bold text-black' : 'text-gray-600'}">Service Policy</a>
            <div class="p-4 flex flex-col gap-3">
                ...
                <a href="/index#book-now" class="block bg-black text-white py-4 rounded-md text-center font-bold">Book Now</a>
            </div>
        </div>
    </nav>`;
